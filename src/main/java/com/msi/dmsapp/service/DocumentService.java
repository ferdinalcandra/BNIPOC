...
public class DocumentService {
	...
	public DocumentEntity documentCountView(Map<String, Object> paramsData) {
		DocumentEntity documentEntity = documentRepository.findByDocumentId(paramsData.get("documentId").toString());
		documentEntity.setDocumentCountView(paramsData.get("documentCountView").toString());
		documentEntity.setLastView(new Date());
